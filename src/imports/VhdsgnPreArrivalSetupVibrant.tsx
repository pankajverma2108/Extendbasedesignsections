...
function Container1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Space_Grotesk:Bold',sans-serif] font-bold h-[16px] justify-center leading-[0] relative shrink-0 text-[#ff2e62] text-[12px] tracking-[1.2px] uppercase w-[129.53px]">
...
function Background() {
  return (
    <div className="absolute bg-[#ff2e62] bottom-[2px] content-stretch flex items-center justify-end left-[0.58%] px-[8px] right-1/2 top-[2px]" data-name="Background">
...
function OverlayBorder() {
  return (
    <div className="bg-[rgba(255,46,98,0.1)] h-[24px] relative rounded-[12px] shrink-0 w-full" data-name="Overlay+Border">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Background />
        <DoodleStyleMarkings />
      </div>
      <div aria-hidden="true" className="absolute border-2 border-[rgba(255,46,98,0.3)] border-solid inset-0 pointer-events-none rounded-[12px]" />
    </div>
  );
}
  ...
  return (
    <div className="h-[18px] relative shrink-0 w-[19px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 18">
        <g id="Container">
          <path d={svgPaths.p549310} fill="var(--fill-0, #FF2E62)" id="Icon" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="bg-white mb-[-0.5px] relative rounded-[12px] shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center px-[16px] py-[4px] relative">
        <div className="flex flex-col font-['Space_Grotesk:Bold',sans-serif] font-bold h-[16px] justify-center leading-[0] relative shrink-0 text-[#ff2e62] text-[12px] text-center uppercase w-[23.344px]">
...
function TowelSticker() {
  return (
    <div className="bg-[#ff2e62] content-stretch flex flex-col items-center pb-[20.5px] pt-[20px] px-[20px] relative rounded-[8px] w-[163px]" data-name="Towel Sticker">
  ...
  return (
    <div className="h-[31.5px] relative shrink-0 w-[24px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 31.5">
        <g id="Container">
          <path d={svgPaths.p415fb40} fill="var(--fill-0, #FF2E62)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Container16() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Space_Grotesk:Regular',sans-serif] font-normal h-[15px] justify-center leading-[0] relative shrink-0 text-[10px] text-[rgba(255,46,98,0.8)] text-center w-[31.551px]">
...
function Button1() {
  return (
    <div className="bg-[#ff2e62] mb-[-0.5px] relative rounded-[12px] shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center px-[16px] py-[4px] relative">
...
function LockSticker() {
  return (
    <div className="bg-[#0f172a] content-stretch flex flex-col items-center pb-[20.5px] pt-[20px] px-[20px] relative rounded-[8px] w-[163px]" data-name="Lock Sticker">
      <div aria-hidden="true" className="absolute border-4 border-[#ff2e62] border-solid inset-0 pointer-events-none rounded-[8px]" />
...
function Container22() {
  return (
    <div className="content-stretch flex flex-col items-end relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Space_Grotesk:Bold',sans-serif] font-bold h-[32px] justify-center leading-[0] relative shrink-0 text-[#ff2e62] text-[24px] text-right w-[43.2px]">
...
function Button2() {
  return (
    <div className="bg-[#ff2e62] content-stretch flex items-center justify-center px-[24px] py-[8px] relative rounded-[4px] shrink-0" data-name="Button">
    ...
    <div className="relative size-[80px]" data-name="Background Doodle Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 80">
        <g id="Background Doodle Icon">
          <path d={svgPaths.p1b031998} fill="var(--fill-0, #FF2E62)" fillOpacity="0.05" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function OverlayBorder1() {
  return (
    <div className="bg-[rgba(255,46,98,0.05)] relative rounded-[8px] shrink-0 w-full" data-name="Overlay+Border">
      ...
      <div aria-hidden="true" className="absolute border-2 border-[rgba(255,46,98,0.4)] border-dashed inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
  ...
  return (
    <div className="h-[17px] relative shrink-0 w-[24px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 17">
        <g id="Container">
          <path d={svgPaths.p2c6c5a00} fill="var(--fill-0, #FF2E62)" id="Icon" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[20.6px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.6 20.6">
        <g id="Container">
          <path d={svgPaths.p317c7780} fill="var(--fill-0, #FF2E62)" id="Icon" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[19.8px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.8 19.8">
        <g id="Container">
          <path d={svgPaths.pc2b8ec0} fill="var(--fill-0, #FF2E62)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Button3() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center px-[34px] py-[10px] relative shrink-0" data-name="Button">
      ...
      <div className="flex flex-col font-['Space_Grotesk:Bold',sans-serif] font-bold h-[24px] justify-center leading-[0] relative shrink-0 text-[#ff2e62] text-[16px] text-center uppercase w-[168.3px]">
...
function BackgroundBorderShadow() {
  return (
    <div className="absolute content-stretch flex flex-col items-center justify-center left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0px] mask-size-[342px_243px] min-h-[200px] p-[34px] right-0 top-0" data-name="Background+Border+Shadow" style={{ backgroundImage: "linear-gradient(134.862deg, rgba(255, 46, 98, 0.1) 0%, rgb(35, 15, 20) 100%), linear-gradient(90deg, rgb(35, 15, 20) 0%, rgb(35, 15, 20) 100%)", maskImage: `url('${imgBackgroundBorderShadow}')` }}>
      <div aria-hidden="true" className="absolute border-2 border-[rgba(255,46,98,0.2)] border-solid inset-0 pointer-events-none" />
      <Container23 />
...
function Button4() {
  return (
    <div className="bg-[#ff2e62] content-stretch flex items-center justify-center py-[20px] relative rounded-[8px] shadow-[0px_8px_0px_0px_#9a1c3b] shrink-0 w-full" data-name="Button">
    ...
    <div className="absolute bottom-[30.03px] right-[20.13px] size-[84.906px]" data-name="Doodle Arrows Floating (Visual Decoration)">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 84.9059 84.9059">
        <g id="Doodle Arrows Floating (Visual Decoration)" opacity="0.2">
          <path d={svgPaths.p3f4ca598} fill="var(--fill-0, #FF2E62)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Heading 2">
      <div className="flex flex-col font-['Space_Grotesk:Bold',sans-serif] font-bold h-[32px] justify-center leading-[0] relative shrink-0 text-[#f1f5f9] text-[24px] text-shadow-[2px_2px_0px_#ff2e62] tracking-[-1.2px] uppercase w-[133.78px]">
  ...
  return (
    <div className="relative shrink-0 size-[25px]" data-name="Container">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 25 25">
        <g id="Container">
          <path d={svgPaths.p17404900} fill="var(--fill-0, #FF2E62)" id="Icon" />
        </g>
      </svg>
    </div>
  );
